...
import consolidationtest2 as fm
import sys
import json
import numpy as np
import calfem.vis as cfv
import tillggtest2 as tg
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        loadUi('mainwindowfinal.ui',self)
        ...
        self.meshSlider.setMaximum(100)
    ...
    def on_updateButton_clicked(self):
        ...
        if not warnings:
            ...
            cfv.drawNodalValues(a0, coords, edof, dofsPerNode, elType, clim=(0,self.inputData.q), draw_elements = False, title = "Initial stress distr.")
